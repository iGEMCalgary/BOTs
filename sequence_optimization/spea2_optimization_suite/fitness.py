...
from sequence_optimization.spea2_optimization_suite.static_biological_data import RibosomeBindingSites, \
    splice_acceptors, splice_donors
import math

"""Code originally written by Brian Weitzner
Modified by JD Rousseau"""
